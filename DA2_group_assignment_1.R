...
rm(list=ls())
df <- read.csv("D:/Dokumentumok/CEU/Data_Analysis_2/amazon_compare.csv") #original dataset to keep as it is
...
# Summary is showing more insights. Especially the NAs. For example, there are 1310 NAs in price_online variable.
...
StdDevByHandout <- (sum(SqDiff(x))/length(x))^0.5
## it is 80.56061
...
## Pharmacy and Health. What can you tell us about variation in this variable? In which plot, histogram or boxplot, is easier to see the quartiles
## of the distribution?
...
var((elec$diff_price)) # variation is 18687.11
...
var(pharmacy$diff_price) # variation is 43.81546

## The variation is much higher in case Electronics than in Pharmacy and Health.
